function createLine(number) {
  ...
  window.onload = function load() {
    ...
    colors[1].setAttribute('style', 'background-color: aqua');
    colors[2].setAttribute('style', 'background-color: darkred');
    colors[3].setAttribute('style', 'background-color: lawngreen');
